...
function CreateEvent() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`http://localhost:4000/api/event/create`, formData);
            setError("");
            navigate("/") 
        } catch (error) {
            setError(error);
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <button className='button-create-event' type='submit'>Create Event</button>
